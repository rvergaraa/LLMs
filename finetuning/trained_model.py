...
config = PeftConfig.from_pretrained("rvergara2017/shin-ft")
model = PeftModel.from_pretrained(model, "rvergara2017/shin-ft")
...
def query(message):
    prompt_template = lambda message: f'''[INST] {intstructions_string} \n{message} \n[/INST]'''
